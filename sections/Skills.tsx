...
const skills: Skill[] = [
  {
    ...
    technologies: ["HTML", "CSS & TailwindCSS", "JS & TS"],
  },
  {
    id: 2,
...
//   },
  {
    ...
    technologies: ["Postgres", "MongoDB", "Redis", "PlanetScale",  "Mongoose"],
  },
//   {
//     id: 7,
...
//   },
  {
    ...
    name: "Photography & Graphic Designing",
    technologies: ["Adobe Illustrator", "Adobe Photoshop", "Adobe InDesign"],
  },
  {
    id: 12,
    icon: "/images/skills/aaa.png",
    name: "Photo & Video Post-Processing",
    technologies: ["Adobe After Effects", "Adobe Premier Pro"],
  },
];
      ...
      {skills.map((skill) => (
        ...
        >
          <div className="w-5 h-5">
            <Image src={skill.icon} width={20} height={20} alt={skill.name} style={{ objectFit: "contain" }} />
          </div>
