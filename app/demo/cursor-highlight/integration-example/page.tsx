      ...
      >
        <div className="max-w-4xl mx-auto p-8">
          ...
          <p className="text-lg mb-4">
            This page demonstrates how the cursor highlight effect can be integrated with actual
            content. Move your cursor around to see the effect while interacting with the page
            content.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-12">
            <div className="bg-card p-6 rounded-lg shadow-md">
              ...
              <p>
                This is an example of how the cursor highlight effect works with cards and other UI
                elements. The effect adds a subtle layer of interactivity without interfering with
                the content.
              </p>
            </div>
            ...
            <div className="bg-card p-6 rounded-lg shadow-md">
              ...
              <p>
                The cursor highlight effect can be customized with different colors, intensities,
                and line spacings to match the design language of your application.
              </p>
            </div>
          </div>
          ...
          <div className="bg-muted p-8 rounded-lg my-8">
            ...
            <p className="mb-4">
              The effect creates a grid of horizontal and vertical lines that respond to the
              cursor's position. Lines within the specified radius of the cursor are highlighted
          ...
          <div className="text-center my-12">
            ...
            <p className="text-lg">
              The cursor highlight effect is available as a reusable component that can be easily
              integrated into any part of your application. Simply wrap your content with the
              CursorHighlightContainer.
            </p>
          </div>
        </div>
